...
<rss version = "2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <link>http://localhost/naomi_php/blog/</link>
    <description>A practice blog about nothing</description>
    <atom:link href="http://localhost/naomi_php/blog/" rel="self" type="application/rss+xml" />
    <?php while( $row = $result->fetch_assoc() ){ ?>
    <item>
      <title><?php echo $row['title']; ?></title>
      <link>http://localhost/naomi_php/blog/single.php?post_id=<?php echo $row['post_id']; ?></link>
      <guid>http://localhost/naomi_php/blog/single.php?post_id=<?php echo $row['post_id']; ?></guid>
